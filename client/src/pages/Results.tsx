        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-xs text-gray-300 bg-gray-900/50 border border-gray-700 px-3 py-1 rounded-full hover:border-blue-500/40 hover:text-blue-200 transition-all"
              aria-expanded={collabOpen}
            >
              {collabOpen ? 'Hide' : 'Show'}
              {collabOpen ? <ChevronUp className="h-3 w-3" /> : <ChevronDown className="h-3 w-3" />}
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
          ...
          {analysisInput?.ideaTitle && (
            <div className="text-xs text-gray-500">
              Idea: <span className="text-gray-300">{analysisInput.ideaTitle}</span>
            </div>
          )}
        </div>
